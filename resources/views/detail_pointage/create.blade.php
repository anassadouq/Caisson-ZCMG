		...
		<form method="post" action="{{ route('detail_pointage.store') }}">
			<table>
				...
				<tr>
					...
					<td><input type="date" name="date" required class="my-4"></td>
				</tr>
				<tr>
					<td><label for="presentAbsent">presentAbsent : </label></td>
					<td><input type="text" name="presentAbsent" required class="my-4"></td>
				</tr>
				<tr>
					<td><label for="heureSupp">heureSupp : </label></td>
					<td><input type="time" name="heureSupp" class="my-4"></td>
				</tr>
				<tr>
					<td><label for="heureMoin">heureMoin : </label></td>
					<td><input type="time" name="heureMoin" class="my-4"></td>
				</tr>
				<tr>
					<td><label for="avance">avance : </label></td>
					<td><input type="text" name="avance" class="my-4"></td>
				</tr>
				<tr>
					<td><label for="remarque">remarque : </label></td>
					<td>
						<input type="text" name="remarque" class="my-4">
