...
@section('content')
    <html>
        ...
        @if (Auth::user()->email == "younes@gmail.com")
            ...
            <a href="{{route('client.create')}}" class="mx-2">
                <button class="btn btn-primary my-4" style="width:85px">
                    <span class="material-symbols-outlined">add</span>
                </button>
            </a>

            <table id="myTable" width="100%" class="text-center">
                <thead>
                    <tr>
                        <th>Num Devis</th>
                        <th>Nom</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('client.destroy', $client->id) }}" method="POST">
                                    ...
                                    Modifier</a>
                                    <button type="submit" class="btn btn-danger mx-3" onclick="return confirmDelete()">
